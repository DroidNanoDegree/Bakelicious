...
public class IngredientsAdpator extends RecyclerView.Adapter<IngredientsAdpator.IngredientsViewHolder> {

    private List<Ingredient> mIngredients;
    private IngredientListItemBinding mIngredientListItemBinding;

    public IngredientsAdpator(List<Ingredient> ingredients) {
