...
public final class BakeliciousSyncUtils {

    private static final String JOB_NAME = "bakelicious_fetch_data";
    ...
    synchronized public static void initDataSync(final Context context) {
        ...
        Thread checkIfDataExists = new Thread(new Runnable() {
            @Override
            public void run() {
                /* query the recipe table to check if there any data already */
                Cursor cursor = context.getContentResolver().query(RecipeEntry.CONTENT_URI,
    ...
    private static void scheduleFirebaseFetchJob(Context context) {
        ...
        Job fetchDataJob = firebaseJobDispatcher.newJobBuilder()
                ...
                .setService(BakeliciousFirebaseJobService.class)
